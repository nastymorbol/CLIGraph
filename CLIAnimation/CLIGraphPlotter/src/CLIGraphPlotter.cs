            ...
            private void PlotData()
            {
                for (int x = _width ; x >= 0; x--)
                {
                    for (int y = _height ; y >= 0; y--)
                    {
                        ...
                        if (y == 0 && x == 0)
                        {
                            SetPosition(x + 1 + _startPositionX, _height + 1 + + _startPositionY);
                            Console.Write("+");
                        }
                        else if (x == 0)
                        {
                            SetPosition(x + 1 + _startPositionX, y + _startPositionY);
                            Console.Write("|");
                        }
                        else if (y == 0)
                        {
                            SetPosition(x + 2 + _startPositionX, _height + 1 + + _startPositionY);
                            Console.Write("-");
                        }
                        else
                        {
                            SetPosition(x + 2 + _startPositionX, y + _startPositionY);
